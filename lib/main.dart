...
//-------------------------------------Handling contact and storage permissions--------------------------------
  ...
  getContacts() async {
    ...
    var pureContacts = await getTrueContacts();      //Skip contacts without phone number
    if(this.mounted) {
        setState(() {
          _trueContacts = pureContacts;
        });
      }
  }
  ...
  handleStoragePermissions() async {
      ...
      var pureContacts = await getTrueContacts();
      if(this.mounted) {
          setState(() {
            _trueContacts = pureContacts;
          });
...
//=================================================BUILD SARTS HERE=================================================
  ...
  Widget _chooseScreen () {
    switch(_activeSelection) {
      ...
      case 1:
        return _miniScreen(_contactsApp);
    } 
